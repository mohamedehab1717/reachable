<?php
// يمكنك هنا لاحقًا تضمين أي عمليات PHP تحتاجها
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <title>Horus Medical and Prosthetics Company</title>
...
<body>
  ...
  <div class="slider-container">
    <div class="slider-track">
      <img src="<?php echo asset('image/image/h1.jpg'); ?>" />
      <img src="<?php echo asset('image/image/h2.jpg'); ?>" />
      <img src="<?php echo asset('image/image/h3.jpg'); ?>" />
      <img src="<?php echo asset('image/image/h4.jpg'); ?>" />
      <img src="<?php echo asset('image/image/h1.jpg'); ?>" />
      <img src="<?php echo asset('image/image/h2.jpg'); ?>" />
      <img src="<?php echo asset('image/image/h3.jpg'); ?>" />
      <img src="<?php echo asset('image/image/h4.jpg'); ?>" />
  ...
  <div class="reachable-info">
    <h1>Horus Medical and Prosthetics Company</h1>
    <div class="location">Cairo, Egypt</div>
    <p>
        ​Horus Medical and Prosthetics Company, founded in 1985 by Dr. Mahrous Taha, is a prominent Egyptian manufacturer and supplier of medical and rehabilitation equipment, headquartered in Cairo. With over five decades of experience in the field, the company specializes in producing high-quality wheelchairs, artificial limbs, hospital beds, walking aids, and other healthcare products designed to support individuals with disabilities.
    </p>
  </div>
  ...
  <div class="key-info">
    <h2>Products</h2>
    <ul>
      <li><strong>-</strong>Artificial Limbs: Below-knee and above-knee prostheses, modular systems, and silicone foot prostheses.</li>
      <li><strong>-</strong>Wheelchairs: Manual, electric, and sports models.</li>
      <li><strong>-</strong>Hospital Equipment: Beds, furniture, and operating tables.</li>
      <li><strong>-</strong>Rehabilitation Products: Walking aids, commode chairs, and oxygen concentrators.</li>
  ...
  <div class="key-info">
    <h2>Location</h2>
    <p><strong>Address:</strong> 25 Dr. Abdallah El Araby St., 7th District, Nasr City, Cairo, Egypt.</p>
    <div class="map">
      <iframe 
        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d441226.84175986465!2d31.6268762!3d30.234661!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583ef5ad15b395%3A0x1159b28bad39c608!2z2YXYtdmG2Lkg2KfZhNis2YXZh9mI2LHZitipINit2YjYsdiz!5e0!3m2!1sen!2seg!4v1745276363236!5m2!1sen!2seg"
        allowfullscreen=""
        loading="lazy"
  ...
  <div class="key-info" style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 40px;">
    <h2>Contact</h2>
    <p><strong>Phone:</strong> +20 2 2385 4065 / +20 122 2138 557</p>
    <p><strong>Email:</strong> info@horus.com.eg​</p>
  </div>
