<?php
// حالياً لا نحتاج كتابة أي كود PHP لأنك قلت لا تغير شيء
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class="slider-container">
    <div class="slider-track">
      <img src="<?php echo asset('image/image/images/48.png'); ?>" />
      <img src="<?php echo asset('image/image/images/lu.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/49.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/48.png'); ?>" />
      <img src="<?php echo asset('image/image/images/lu.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/49.jpg'); ?>" />
  ...
  <!-- MALL info -->
  <div class="mall info">
    <p style="text-align: center; font-size: 32px ; font-weight: bold;">lulu</p>
    <div class="location">Cairo, Egypt</div>
    <p>
        It is known for offering a wide variety of products including groceries, electronics, fashion, household items, and fresh food at competitive prices. LuLu has a strong presence in the Middle East, Asia, and parts of Africa, and is especially popular among diverse communities due to its international product range. The stores are well-organized, customer-friendly, and often feature dedicated sections for different cultures and dietary needs.
    </p>
  </div>
  ...
  <div class="key-info">
    <h2>Features</h2>
    <ul>
        <li><strong>-</strong> Wide, wheelchair-accessible entrances</li>
        <li><strong>-</strong> Elevators and ramps for easy access between floors</li>
        <li><strong>-</strong> Reserved parking spaces near the entrance</li>
        <li><strong>-</strong> Fully equipped accessible restrooms</li>
        <li><strong>-</strong> Staff trained to assist customers with special needs</li>
        <li><strong>-</strong> Clear visual and auditory signs for easy navigation</li>
    </ul>
  </div>
  ...
  <div class="key-info">
    <h2>Location</h2>
    <p><strong>Address:</strong> Next to, Basement Floor 1, New Cairo, 1st Settlement, in Emerald Mall, Police Academy Passage, New Cairo 1, Cairo Governorate</p>
    <div class="map">
      <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d110578.71080537223!2d31.398691198791425!3d29.9913627338343!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1slulu%20hyper!5e0!3m2!1sen!2seg!4v1745438930420!5m2!1sen!2seg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
