<?php
// لا تغيير في الـ HTML — فقط بداية ملف PHP
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <title>mall of egypt</title>
...
<div class="slider-container">
  ...
  <img src="<?php echo asset('image/image/images/5.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/6.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/7.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/5.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/6.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/7.jpg'); ?>" />
      <img src="<?php echo asset('image/image/images/5.jpg'); ?>" />
...
<div class="reachable-info">
   <p>Mall of egypt </p>
   <div class="location">6th October, Cairo, Egypt</div>
   <p>
     Mall of Egypt is a premium shopping and entertainment destination in Cairo, offering a wide variety of international brands, restaurants, and family attractions. It's fully equipped with accessibility features, making it a great choice for visitors with special needs.
   </p>
</div>
...
<div class="key-info">
  ...
  <ul>
    ...
    <li>- Elevators with braille and voice announcements</li>
    <li>- Accessible restrooms</li>
    <li>- Designated parking for disabled guests</li>
    <li>- Spacious corridors and automatic doors</li>
  </ul>
</div>

<!-- Location -->
<div class="key-info">
  <p>Address: Wahat Road, 6th of October City, Giza Governorate, Egypt</p>
  <div class="map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d55291.288821750524!2d30.9555037973596!3d29.98789103745832!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1small%20of%20egypt!5e0!3m2!1sen!2seg!4v1745541352140!5m2!1sen!2seg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
</div>
...
<div style="margin-bottom: 40px;">
  ...
  <div class="feedback-card" style="margin-bottom: 20px; background: #f8f8f8; padding: 15px 20px; border-radius: 12px;">
    <p style="margin: 0; font-size: 15px;">"The instructors were incredibly supportive and the equipment was top-notch. "</p>
    <div style="color: #FFD700; margin-top: 5px;">★★★★☆</div>
  </div>

  <div class="feedback-card" style="margin-bottom: 20px; background: #f8f8f8; padding: 15px 20px; border-radius: 12px;">
    <p style="margin: 0; font-size: 15px;">"Great facilities and very inspiring athletes."</p>
    <div style="color: #FFD700; margin-top: 5px;">★★★★★</div>
  </div>
</div>
